...
var real___GLOBAL__sub_I_wasmdec_cc = asm["__GLOBAL__sub_I_wasmdec_cc"]; asm["__GLOBAL__sub_I_wasmdec_cc"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
...
var real__wasmdec_create_decompiler = asm["_wasmdec_create_decompiler"]; asm["_wasmdec_create_decompiler"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__wasmdec_create_decompiler.apply(null, arguments);
};

var real__wasmdec_decompile = asm["_wasmdec_decompile"]; asm["_wasmdec_decompile"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__wasmdec_decompile.apply(null, arguments);
};

var real__wasmdec_destroy_decompiler = asm["_wasmdec_destroy_decompiler"]; asm["_wasmdec_destroy_decompiler"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__wasmdec_destroy_decompiler.apply(null, arguments);
};

var real__wasmdec_get_decompiled_code = asm["_wasmdec_get_decompiled_code"]; asm["_wasmdec_get_decompiled_code"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
